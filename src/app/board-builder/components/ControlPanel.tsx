...
export default function ControlPanel({
  ...
  return (
    <section className="rounded-md bg-black/[.02] dark:bg-white/[.04] h-full w-full flex items-stretch justify-start overflow-y-auto">
      <div className="flex flex-col items-start gap-3 md:gap-4 py-2 w-full pl-2">
        {/* Randomize */}
