    ...
    <main className="min-h-screen w-full flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-5xl grid gap-10">
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-6 md:p-10 flex flex-col gap-4">
              <div className="inline-flex items-center gap-2 self-start rounded-full border border-emerald-300/60 bg-emerald-100/60 text-emerald-900 px-3 py-1 text-xs font-semibold dark:bg-emerald-900/30 dark:text-emerald-100 dark:border-emerald-700/50">
                ...
                <span className="h-1 w-1 rounded-full bg-emerald-700/70 dark:bg-emerald-300/70" />
                <span>50% off bottle openers</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-semibold leading-tight">Beautiful, custom boards. Built for the work you love.</h1>
              <p className="text-sm md:text-base opacity-80 max-w-prose">
                Design your perfect pattern, pick your edge and groove, then check out with confidence. Hand crafted finishes and premium hardwoods.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative h-full w-full aspect-[16/12] md:aspect-auto flex items-center justify-center text-emerald-900/70 dark:text-emerald-200/70 text-sm">
                Aesthetic testimonial (placeholder)
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="bottle-openers" className="rounded-xl border border-black/10 dark:border-white/10 p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">Bottle Openers</h2>
            <button
              type="button"
